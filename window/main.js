...
//By calling the window reference of the current DOM that we are using
...
----------------------------------------------------------------------------*/
//Save the 'div' with the ID = 'main' into a variable
//var main = document.getElementById('main', '::after');

//Prints all the CSS properties whether if they've already been set or no.
//console.log(window.getComputedStyle(main));
